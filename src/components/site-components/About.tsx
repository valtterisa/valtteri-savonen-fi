        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl">
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8">
              I create my own opportunities. I believe the future is not
              something that simply happens to us. It is something we have the
              power to shape with every idea we bring to life and every product
              we choose to build. Engineering is not just a skill I practice; it
