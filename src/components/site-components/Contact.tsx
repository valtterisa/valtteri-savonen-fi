  ...
  return (
    <div className="w-full px-4 sm:px-8 md:px-16">
      <div className="w-full max-w-7xl mx-auto">
        <h2
          className={`${isMobile ? "text-3xl sm:text-4xl" : "text-4xl md:text-5xl"} font-bold mb-6 sm:mb-10 md:mb-16`}
        >
          Contact
        </h2>
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          <div>
            <p
              className={`${isMobile ? "text-base sm:text-lg" : "text-lg md:text-xl"} text-gray-300 mb-6 sm:mb-8 md:mb-10`}
            >
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="border border-gray-700 p-2 sm:p-3 md:p-4">
                  <Mail
                    className={`${isMobile ? "w-4 h-4" : "w-5 h-5 md:w-6 md:h-6"}`}
                  />
                </div>
                <span
                  className={`${isMobile ? "text-base sm:text-lg" : "text-lg md:text-xl"}`}
                >
